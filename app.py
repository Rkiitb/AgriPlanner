...
st.set_page_config(page_title='None', page_icon='🌱', layout="centered", initial_sidebar_state="auto", menu_items={'About':"This is me -https://www.linkedin.com/in/rakesh-kumar-5b7a74234"})
...
def intro():
    ...
    st.markdown(
        """
        ## Welcome to our Farmer's Corner!
    """
    )
